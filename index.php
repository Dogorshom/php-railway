						...
						<div class="inner">
							...
							<ul class="contact">
								<li class="icon solid fa-home">
									...
									Graduation project  uni Al-Bayan<br />
									
								</li>
								<li class="icon solid fa-phone">(+249) 1254001160</li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Bayan University Students Graduation Project: Taqwa, Ashraf, Adam</li>
							</ul>
						</div>
					</section>
