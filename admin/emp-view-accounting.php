        ...
        <div class="row">
            <div class="col-12 col-lg-6 col-xl-6">
              ...
              <div class="chart sparkline"><i class="material-icons">attach_money</i></div>
                <div class="data-info">
                <?php
                  $result ="SELECT SUM(train_fare) FROM orrs_train_tickets WHERE confirmation = 'Approved'";
                  ...
                  <div class="value">$<span class="number" data-toggle="counter" data-end="<?php echo $count_fare;?>">0</span>
                  </div>
                </div>
              </div>
            </div>
