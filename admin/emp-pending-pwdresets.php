 ...
 <!-- end HEAD--> 
  <body>
    ...
    <!--navbar-->
      ...
      <div class="page-head">
          <h2 class="page-head-title">Pending Password Resets</h2>
                ...
                <div class="card-body">
                  <table class="table table-striped table-bordered table-hover table-fw-widget" id="table1">
                    ...
                    <?php
                        ...
                        */
                        $ret="SELECT * FROM `orrs_passwordresets` where status !='Approved'  "; 
                    ...
                    ?>
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        ...
                        <td class="center"><a class ="badge badge-success" href ="emp-confirm-password_reset.php?pwd_id=<?php echo $row->pwd_id;?>">Approve</a> 
                            <hr> <a class ="badge badge-danger" href ="emp-pending-pwdresets.php?del=<?php echo $row->pwd_id;?>">Delete</a>
                        </td>    
