<?php
    ...
    if(isset($_POST['Update_profile_pic']))
    {
            ...
            */
            ...
            $query="update  orrs_employee set emp_dpic = ? where emp_id=?";
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-border-color card-border-color-success">
                <div class="card-header card-header-divider">Update Your Profile Photo<span class="card-subtitle">Fill All Details</span></div>
                <div class="card-body">
